...
var DropdownComponent = function () {
    ...
    var DropdownComponent = _classThis = /** @class */ (function () {
        function DropdownComponent_1() {
            this.title = __runInitializers(this, _title_initializers, '');
            this.active = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _active_initializers, false));
            this.selectSignal = (__runInitializers(this, _active_extraInitializers), (0, core_1.signal)(''));
            this.select = '';
            this.options = (0, core_1.input)(['']);
        }
        DropdownComponent_1.prototype.sinalizar = function () {
